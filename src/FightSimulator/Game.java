...
public class Game {
    public static void main(String[] args) {
        ...
        System.out.println("게임 설명 : q / 바로시작 : r");
        ...
        if (beforgame.equals("q")) {
            ...
            System.out.println("- 스킬 사용은 player1은 q,w,e,r, player2는 u,i,o,p로 구분됩니다.");
            System.out.println("3. 게임 종료");
            System.out.println("- 체력이 0이 되면 게임이 종료됩니다.");
        } else if (beforgame.equals("r")) {
        ...
        while (true) {
            ...
            System.out.println();
            System.out.println("플레이어 1의 차례");
            System.out.println("q : skill1, w : skill2, e : defenseskill, r : heal");
            ...
            System.out.println(player1.name + " | 체력: " + player1.hp + " | 마나: " + player1.mp + " | 공격력: "
                    + player1.atk + " | 방어력: " + player1.def);
            System.out.println(player2.name + " | 체력: " + player2.hp + " | 마나: " + player2.mp + " | 공격력: "
                    + player2.atk + " | 방어력: " + player2.def);

            if (player1.hp <= 0) {
                System.out.println("============ 게임 종료 ============");
                System.out.println(player2.name + "가 승리했습니다!");
                System.out.println("다시하기 : r, 종료 : q");
